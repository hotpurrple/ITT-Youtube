...
export const categoriesForCategoriesBar = [
  ...
  { name: "Вили Вуцов" },
  { name: "Перуката" },
  { name: "Боби Михайлов денси" },
  { name: "Гледай си работата" },
  { name: "Китодар" },
  ...
  { name: "Oleksander Usik" },
  { name: "Wilder" },
  { name: "Avengers" },
  { name: "Robert Downey" },
  { name: "Max Verstappen" },
  { name: "Red Bull Dynamic" },
  { name: "Diablo 2" },
  { name: "Warcraft" },
  { name: "Warcraft 2" },
  { name: "Warcraft 3" },
  ...
  { name: "Bitcoin" },
  { name: "Cris Fix" },
  { name: "Ratches and wrenches" },
  { name: "Eric the car guy" },
  { name: "Karatok" },
  { name: "Новини" },
  { name: "Тото" },
  { name: "Bikes" },
